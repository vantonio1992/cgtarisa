...
net = 'CNN_ae_bias_{}x{}'.format(sy,sx)
...
output_shape1 = tf.constant(np.array([train_batch,sy,sx,]))
...
# h_deconv2 = tf.nn.relu(conv2d(unpool2 - b_conv2, W_conv2_tr))
unpool1 = unpool_2x2(h_pool1,sy/2,sx/2,nf1)
...
showplot(input_rgb,output_rgb, sy, sx, image_reco, 'test')